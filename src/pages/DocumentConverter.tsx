...
const supportedFormats = [
  ...
  {
    ext: "DOC",
    description: "Convert DOC documents to other formats",
    path: "/document-converter/doc",
  },
  {
    ext: "DOCX",
    description: "Convert DOCX documents to other formats",
    path: "/document-converter/docx",
  },
  {
    ext: "TXT",
    description: "Convert TXT documents to other formats",
    path: "/document-converter/txt",
  },
  {
    ext: "RTF",
    description: "Convert RTF documents to other formats",
